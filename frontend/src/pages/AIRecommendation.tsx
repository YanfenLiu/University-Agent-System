      ...
      <div>
        ...
        <Typography.Text type="secondary" style={{ fontSize: 15 }}>
          智能分析你的背景，自动规划最优竞赛路线
            ...
            {/* 主区域：左右两列等高 */}
            <Row gutter={24} style={{ minHeight: 480, maxHeight: "calc(100vh - 210px)", overflow: "hidden" }}>
        {/* 左侧：对话区 */}
        <Col xs={24} md={16}>
                    <div
                        style={{
          ...
          >
            ...
            {/* 输入区域 */}
            <div style={{ padding: "10px 20px 20px", borderTop: "1px solid rgba(15, 23, 42, 0.06)", background: "#fff" }}>
              <Input.TextArea
                ref={inputRef}
                value={input}
                                rows={1}
